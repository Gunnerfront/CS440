    ...
    for sentence in test:
        ...
        for word in sentence:
            ...
            if word_count == 0:
                ...
                for tag in tags:
                    tag_idx = get_tag_index(tags, tag)
                    log_b = 0.
                ...
                for tag in tags:  # these represent the current tag nodes
                    ...
                    outer_tag_idx = get_tag_index(tags, tag)
                    for inner_tag in tags:  # these represent the previous tag nodes
                        inner_tag_idx = get_tag_index(tags, inner_tag)
        ...
        tagged_sentence = TrellisToTaggedSentence(trellis, sentence)
...
def TrellisToTaggedSentence(trellis, sentence):
